...
export const docsConfig: DocsConfig = {
  items: [
    ...
    {
      title: "Vokabular",
      href: "/a1niveau/vokabular",
      items: [
        {
          title: "Start auf Deutsch",
          description: "Từ vựng cơ bản để bắt đầu học tiếng Đức - giới thiệu bản thân và những từ đầu tiên",
        ...
        },
        {
          ...
          description: "Từ vựng về đồ uống và cách gọi món trong nhà hàng, quán cà phê",
        ...
        {
          title: "Sprache im Kurs",
          description: "Ngôn ngữ sử dụng trong lớp học - hướng dẫn và giao tiếp cơ bản",
          href: "/a1niveau/vokabular/03-sprache-im-kurs",
          items: [
            { title: "Wörter und Fragen", href: "/a1niveau/vokabular/03-sprache-im-kurs/01-worter-und-fragen" },
            { title: "Mit Wörterbüchern arbeiten", href: "/a1niveau/vokabular/03-sprache-im-kurs/02-mit-worterbuchern-arbeiten" },
            { title: "Ist das ein", href: "/a1niveau/vokabular/03-sprache-im-kurs/03-ist-das-ein" },
            { title: "Menschen Kurse Sprachen", href: "/a1niveau/vokabular/03-sprache-im-kurs/04-menschen-kurse-sprachen" },
            { title: "Übung 2 A1", href: "/a1niveau/vokabular/03-sprache-im-kurs/05-ubung-2-a1" },
            { title: "Verb-Adj-Adv 3 A1", href: "/a1niveau/vokabular/03-sprache-im-kurs/06-verb-adj-adv-3-a1" },
          ]
        },
        {
        ...
        {
          title: "Station 1",
          description: "Trạm dừng 1 - ôn tập và củng cố kiến thức đã học",
          href: "/a1niveau/vokabular/05-station-1",
          items: [
            { title: "Berufsbilder 1 A1", href: "/a1niveau/vokabular/05-station-1/01-berufsbilder-1-a1" },
            { title: "Themen und Texte 1 A1", href: "/a1niveau/vokabular/05-station-1/02-themen-und-texte-1-a1" },
            { title: "Wörter Spiele Training 1 A1", href: "/a1niveau/vokabular/05-station-1/03-worter-spiele-training-1-a1" },
            { title: "Filmstation 1 A1", href: "/a1niveau/vokabular/05-station-1/04-filmstation-1-a1" },
            { title: "Verb-Adj-Adv 5 A1", href: "/a1niveau/vokabular/05-station-1/05-verb-adj-adv-5-a1" },
          ]
        },
        {
          title: "Menschen und Häuser",
          description: "Từ vựng về con người, gia đình và nhà ở",
        ...
        {
          title: "Sprache im Kurs 2",
          description: "Ngôn ngữ sử dụng trong lớp học phần 2 - nâng cao kỹ năng giao tiếp",
          href: "/a1niveau/vokabular/08-sprache-im-kurs-2",
          items: [
            { title: "Arbeiten in Leipzig", href: "/a1niveau/vokabular/08-sprache-im-kurs-2/01-arbeiten-in-leipzig" },
            { title: "In der Unibibliothek", href: "/a1niveau/vokabular/08-sprache-im-kurs-2/02-in-der-unibibliothek" },
        ...
        },
        {
          ...
          description: "Từ vựng về nghỉ dưỡng và đi du lịch",
          href: "/a1niveau/vokabular/12-ab-in-den-urlaub",
          items: [
            { title: "Willkommen im Reiseland Deutsch", href: "/a1niveau/vokabular/12-ab-in-den-urlaub/01-willkommen-im-reiseland-deutsch" },
            { title: "Familie Mertens im Urlaub", href: "/a1niveau/vokabular/12-ab-in-den-urlaub/02-familie-mertens-im-urlaub" },
            { title: "Was ist passiert", href: "/a1niveau/vokabular/12-ab-in-den-urlaub/03-was-ist-passiert" },
            { title: "Urlaubsplanung und Ferientermine", href: "/a1niveau/vokabular/12-ab-in-den-urlaub/04-urlaubsplanung-und-ferientermine" },
            { title: "Urlaub mit dem Auto", href: "/a1niveau/vokabular/12-ab-in-den-urlaub/05-urlaub-mit-dem-auto" },
            { title: "Übung 9 A1", href: "/a1niveau/vokabular/12-ab-in-den-urlaub/06-ubung-9-a1" },
            { title: "Verb-Adj-Adv 12 A1", href: "/a1niveau/vokabular/12-ab-in-den-urlaub/07-verb-adj-adv-12-a1" },
          ]
        },
        {
          title: "Station 3",
          description: "Trạm dừng 3 - tổng hợp và thực hành toàn diện",
          href: "/a1niveau/vokabular/13-station-3",
          items: [
            { title: "Berufsbilder 3 A1", href: "/a1niveau/vokabular/13-station-3/01-berufsbilder-3-a1" },
            { title: "Wörter Spiele Training 3 A1", href: "/a1niveau/vokabular/13-station-3/02-worter-spiele-training-3-a1" },
            { title: "Filmstation 3 A1", href: "/a1niveau/vokabular/13-station-3/03-filmstation-3-a1" },
            { title: "Magazin 3 A1", href: "/a1niveau/vokabular/13-station-3/04-magazin-3-a1" },
            { title: "Verb-Adj-Adv 13 A1", href: "/a1niveau/vokabular/13-station-3/05-verb-adj-adv-13-a1" },
          ]
        },
        {
    ...
    },
    {
      ...
      href: "/a1niveau/vokabular-thema",
      items: [
        {
          title: "Farben - Màu sắc",
          description: "Từ vựng về các màu sắc cơ bản và nâng cao trong tiếng Đức",
          href: "/a1niveau/vokabular-thema/01-farben",
        },
        {
          title: "Das Wetter - Thời tiết",
          description: "Từ vựng mô tả thời tiết và hiện tượng thiên nhiên",
          href: "/a1niveau/vokabular-thema/02-das-wetter",
        },
        {
          title: "Von Kopf bis Fuß - Cơ thể con người",
          description: "Từ vựng về các bộ phận cơ thể từ đầu đến chân",
          href: "/a1niveau/vokabular-thema/03-von-kopf-bis-fuss",
        },
        {
          title: "Gesundheit - Sức khỏe",
          description: "Từ vựng về sức khỏe, bệnh tật và chăm sóc y tế",
          href: "/a1niveau/vokabular-thema/04-gesundheit",
        },
        {
          title: "Sport - Thể thao",
          description: "Từ vựng về các môn thể thao và hoạt động vận động",
          href: "/a1niveau/vokabular-thema/05-sport",
        },
        {
          title: "100 Verben phổ biến A1",
          description: "100 động từ phổ biến nhất cần biết ở trình độ A1",
          href: "/a1niveau/vokabular-thema/100-verb-pho-bien-a1",
          items: [
            { title: "50 verb phổ biến 1 A1", href: "/a1niveau/vokabular-thema/100-verb-pho-bien-a1/01-50-verb-pho-bien-1-a1" },
            { title: "50 verb phổ biến 2 A1", href: "/a1niveau/vokabular-thema/100-verb-pho-bien-a1/02-50-verb-pho-bien-2-a1" },
          ]
        },
        {
          title: "100 Adjektive phổ biến A1",
          description: "100 tính từ phổ biến nhất cần biết ở trình độ A1",
          href: "/a1niveau/vokabular-thema/100-adj-pho-bien-a1",
          items: [
            { title: "50 adj phổ biến 1 A1", href: "/a1niveau/vokabular-thema/100-adj-pho-bien-a1/01-50-adj-pho-bien-1-a1" },
            { title: "50 adj phổ biến 2 A1", href: "/a1niveau/vokabular-thema/100-adj-pho-bien-a1/02-50-adj-pho-bien-2-a1" },
          ]
        },
        {
          title: "100 Adverbien phổ biến A1",
          description: "100 trạng từ phổ biến nhất cần biết ở trình độ A1",
          href: "/a1niveau/vokabular-thema/100-adv-pho-bien-a1",
          items: [
            { title: "50 adv phổ biến 1 A1", href: "/a1niveau/vokabular-thema/100-adv-pho-bien-a1/01-50-adv-pho-bien-1-a1" },
            { title: "50 adv phổ biến 2 A1", href: "/a1niveau/vokabular-thema/100-adv-pho-bien-a1/02-50-adv-pho-bien-2-a1" },
          ]
        },
      ],
    },
