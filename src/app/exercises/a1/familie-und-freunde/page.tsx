      ...
      <main className="container mx-auto max-w-5xl py-8 px-4">
        ...
        <div className="mb-8">
          <nav className="mb-6 flex items-center space-x-2 text-sm text-muted-foreground">
            ...
            <span className="text-purple-300">→</span>
            <div className="text-purple-700 font-semibold">Familie und Freunde</div>
          </nav>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-purple-100 p-8 mb-8">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
                Học về gia đình và bạn bè bằng tiếng Đức thông qua các bài tập nghe và từ vựng thực tế.
              </p>
            </div>
          </div>
        </div>
