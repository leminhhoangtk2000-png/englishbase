...
**Subjekt + werden (chia theo chủ ngữ) + Infinitiv**
:::
...
- "werden" đứng ở vị trí số 2 trong câu.
...
## **3. So sánh Präsens & Futur I**

| **Präsens (hiện tại dùng cho tương lai)**                     | **Futur I (tương lai đơn)**                                                 |
| ------------------------------------------------------------- | --------------------------------------------------------------------------- |
| Dùng khi có mốc thời gian rõ ràng.                            | Dùng khi muốn nhấn mạnh dự đoán/kế hoạch.                                   |
...
## **5. Câu bị động ở Futur I (Passiv)**
...
- Dùng **haben** cho hầu hết động từ.
- Dùng **sein** với động từ chỉ chuyển động/thay đổi trạng thái.
- Futur II thường đi kèm cụm từ chỉ mốc thời gian: _bis dahin, nächstes Jahr…_
...
- **Futur I = werden + Infinitiv → kế hoạch/dự đoán trong tương lai.**
- **Präsens có thể thay thế Futur I khi có mốc thời gian rõ ràng.**
- **Futur I với Modalverben = werden + Modalverb + Infinitiv.**
- **Passiv im Futur I = werden (Präsens) + Partizip II + werden (Infinitiv).**
- **Futur II = werden + Partizip II + haben/sein → hành động hoàn thành trong tương lai.**
  :::
