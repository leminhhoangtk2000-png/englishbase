...
- **haben** được dùng với hầu hết các động từ, **sein** với động từ di chuyển hoặc thay đổi trạng thái (gehen, kommen, bleiben...).
...
- **"Nachdem" luôn đi kèm với Plusquamperfekt** để chỉ hành động xảy ra trước.
