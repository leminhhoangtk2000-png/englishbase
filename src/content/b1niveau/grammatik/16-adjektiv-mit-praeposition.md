...
:::note[❗ Người học B2 thường sai ở chỗ:]
...
## 📚 **3. Bảng Adjektiv mit Präposition (B1–B2)**

### 🔹 Tính từ đi với Akkusativ

| Adjektiv     | Präposition | Nghĩa             | Ví dụ                                                |
| ------------ | ----------- | ----------------- | ---------------------------------------------------- |
| stolz        | auf         | tự hào về         | Sie ist **stolz auf** ihre Arbeit im Projekt.        |
| gespannt     | auf         | háo hức, mong chờ | Wir sind **gespannt auf** die Ergebnisse der Studie. |
...
📌 Trong văn viết (báo cáo, luận văn…), các cụm tính từ + giới từ thường được **danh từ hóa** để trang trọng hơn:

| Tính từ + Präp.   | Danh từ hóa                | Ví dụ                                                                 |
| ----------------- | -------------------------- | --------------------------------------------------------------------- |
...
:::note[💡 Câu gián tiếp / bị động học thuật]
💡 Câu gián tiếp / bị động học thuật
...
- Mệnh đề quan hệ: giới từ **đứng trước đại từ quan hệ**.
- Lỗi phổ biến: chọn sai giới từ hoặc sai cách (Kasus).
