...
| Động từ   | Nghĩa              | Ví dụ câu đầy đủ                                           |
| --------- | ------------------ | ---------------------------------------------------------- |
...
| Động từ         | Danh từ hóa               | Ví dụ học thuật                                            |
| --------------- | ------------------------- | ---------------------------------------------------------- |
...
| Ich erkläre **ihm** **sie**. _(cô ấy)_ | Ich erkläre **sie ihm**. _(„sie“ là Akk – đại từ)_ | Akkusativ (đại từ) đứng trước |
...
- Cần chú ý khi đổi vị trí hoặc dùng bị động.
- Không phải động từ nào cũng có hai tân ngữ → cần học thuộc.
- Dạng danh từ hóa xuất hiện nhiều trong **báo cáo, thư từ, văn viết học thuật**.
