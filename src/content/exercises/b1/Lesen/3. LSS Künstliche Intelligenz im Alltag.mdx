  ...
  questions={[
    {
      ...
      explanation:
        "Trí tuệ nhân tạo không chỉ dùng trong điện thoại mà còn ở xe tự lái và nhiều lĩnh vực khác, nên câu này sai.",
    },
    {
      question: "Sprachassistenten wie Alexa können den Alltag erleichtern.",
      correctAnswer: "Richtig",
      explanation:
        "Trợ lý giọng nói như Alexa giúp bật đèn, phát nhạc, lập danh sách mua sắm, làm cuộc sống dễ hơn, nên câu này đúng.",
    },
    {
      question:
        "KI kann in Firmen Datenmengen analysieren und Prozesse optimieren.",
      correctAnswer: "Richtig",
      explanation:
        "KI được dùng trong công việc để phân tích dữ liệu và cải thiện quy trình, nên câu này đúng.",
    },
    {
      question: "Im Gesundheitswesen hilft KI, Diagnosen schneller zu stellen.",
      correctAnswer: "Richtig",
      explanation:
        "KI hỗ trợ bác sĩ chẩn đoán nhanh hơn qua việc phân tích hình ảnh X-quang hoặc xét nghiệm máu, nên câu này đúng.",
    },
    {
      question:
        "Alle Länder können sich die Entwicklung von KI leicht leisten.",
      correctAnswer: "Falsch",
      explanation:
        "Phát triển KI rất tốn kém và không phải quốc gia nào cũng đủ khả năng chi trả, nên câu này sai.",
    },
    {
      question: "Die Privatsphäre der Menschen ist durch KI nie in Gefahr.",
      correctAnswer: "Falsch",
      explanation:
        "Một số người lo KI có thể gây nguy hiểm cho quyền riêng tư, nên nói rằng nó không bao giờ nguy hiểm là sai.",
    },
    {
      question: "Selbstfahrende Autos mit KI brauchen keine Regulierungen.",
      correctAnswer: "Falsch",
      explanation:
        "Xe tự lái cần quy định chặt chẽ để tránh lạm dụng, nên nói không cần quy định là sai.",
    },
    {
      question: "KI könnte in der Zukunft Jobs ersetzen.",
      correctAnswer: "Richtig",
      explanation:
        "KI có thể thay thế công việc từ nhà máy đến văn phòng nếu phát triển hơn, nên câu này đúng.",
    },
    {
      question:
        "Lernprogramme mit KI machen den Unterricht in Schulen individueller.",
      correctAnswer: "Richtig",
      explanation:
        "Chương trình học bằng KI có thể tùy chỉnh bài giảng cho từng học sinh, giúp học nhanh hơn, nên câu này đúng.",
    },
    {
      question: "Es gibt keine ethischen Fragen bei der Nutzung von KI.",
      correctAnswer: "Falsch",
      explanation:
        "Việc sử dụng KI đặt ra vấn đề đạo đức, như quyết định sống chết trong xe tự lái, nên nói không có vấn đề đạo đức là sai.",
    },
  ]}
/>
...
<ExerciseComments
  exerciseId="b1-3.-lss-künstliche-intelligenz-im-alltag"
  url="/exercises/b1/Lesen/3. LSS Künstliche Intelligenz im Alltag"
/>
