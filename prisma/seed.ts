...
async function seedVocabulary() {
  ...
  const vocabularyFiles = [
    ...
    'vocabulary-activities.json',
    'vocabulary-body.json',
    'vocabulary-communication-cafe.json',
    'vocabulary-communication.json',
    'vocabulary-countries.json',
    'vocabulary-daily-life.json',
    'vocabulary-family-extended.json',
    'vocabulary-family.json',
    'vocabulary-food-drink.json',
    'vocabulary-general.json',
    'vocabulary-grammar.json',
    'vocabulary-learning.json',
    'vocabulary-media.json',
    'vocabulary-objects.json',
    'vocabulary-payment.json',
    'vocabulary-people.json',
    'vocabulary-places.json',
    'vocabulary-professions.json',
    'vocabulary-relationships.json',
    'vocabulary-sports.json',
    'vocabulary-technology.json'
  ]
